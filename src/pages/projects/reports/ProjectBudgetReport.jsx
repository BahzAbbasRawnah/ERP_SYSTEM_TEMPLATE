      ...
      <div className="template-container">
        ...
        <div className="report-section">
          ...
          <div className="mb-8">
            ...
            <TemplateBody columns={budgetColumns} data={budgetBreakdown} showTotal={true} totalAmount={defaultBudgetData.totalBudget} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">الإنفاق الشهري</h3>
            <TemplateBody columns={spendingColumns} data={monthlySpending} showTotal={false} />
          </div>
