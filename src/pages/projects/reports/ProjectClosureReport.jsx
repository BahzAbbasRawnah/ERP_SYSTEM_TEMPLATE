      ...
      <div className="template-container">
        ...
        <div className="report-section">
          ...
          <div className="mb-8">
            ...
            <TemplateBody columns={deliverablesColumns} data={deliverables} showTotal={false} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">مؤشرات الأداء النهائية</h3>
            <TemplateBody columns={metricsColumns} data={finalMetrics} showTotal={false} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">الدروس المستفادة</h3>
            <TemplateBody columns={lessonsColumns} data={lessonsLearned} showTotal={false} />
          </div>
