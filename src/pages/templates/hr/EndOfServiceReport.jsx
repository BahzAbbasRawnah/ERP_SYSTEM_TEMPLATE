        ...
        <div className="template-body">
          ...
          <div className="grid grid-cols-2 gap-8 mb-6">
            <div>
              ...
              <TemplateTable columns={benefitsColumns} data={benefitsData} showTotal={true} totalAmount={totalBenefits} />
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Deductions</h3>
              <TemplateTable columns={deductionsColumns} data={deductionsData} showTotal={true} totalAmount={totalDeductions} />
            </div>
          </div>
