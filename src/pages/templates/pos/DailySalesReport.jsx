      ...
      <div className="template-print-container max-w-5xl mx-auto bg-white">
        ...
        <div className="template-body">
          ...
          <div className="mb-8">
            ...
            <TemplateTable columns={hourlyColumns} data={hourlyBreakdown} showTotal={true} totalAmount={defaultDailyData.totalSales} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">تفاصيل المعاملات (أول 5 معاملات)</h3>
            <TemplateTable columns={transactionColumns} data={transactionDetails} showTotal={false} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">أفضل المنتجات مبيعاً</h3>
            <TemplateTable columns={productColumns} data={productSales} showTotal={false} />
          </div>
          ...
          <SignatureSection 
            preparedByLabel="مشرف الوردية"
            approvedByLabel="مدير المتجر"
          />
        </div>
      </div>
    </div>
