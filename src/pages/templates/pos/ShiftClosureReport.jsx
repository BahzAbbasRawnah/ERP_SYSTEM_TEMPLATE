      ...
      <div className="template-print-container max-w-5xl mx-auto bg-white">
        ...
        <div className="template-body">
          ...
          <div className="mb-8">
            ...
            <TemplateTable columns={summaryColumns} data={salesSummary} showTotal={false} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">تفاصيل المعاملات</h3>
            <TemplateTable columns={transactionColumns} data={transactions} showTotal={false} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">جرد النقدية</h3>
            <TemplateTable columns={cashColumns} data={cashBreakdown} showTotal={true} totalAmount={totalCashCount} />
          </div>
          ...
          <SignatureSection 
            preparedByLabel="الكاشير"
            approvedByLabel="مشرف الوردية"
          />
        </div>
      </div>
    </div>
