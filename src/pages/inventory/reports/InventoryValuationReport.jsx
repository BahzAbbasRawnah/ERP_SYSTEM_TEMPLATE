      ...
      <div className="template-container">
        ...
        <div className="report-section">
          ...
          <div className="mb-8">
            ...
            <TemplateBody columns={categoryColumns} data={categoryData} showTotal={true} totalAmount={defaultReportData.totalValue} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">أعلى 5 أصناف قيمة</h3>
            <TemplateBody columns={itemsColumns} data={topValueItems} showTotal={false} />
          </div>
