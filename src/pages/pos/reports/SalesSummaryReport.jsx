      ...
      <div className="template-container">
        ...
        <div className="report-section">
          ...
          <div className="mb-8">
            ...
            <TemplateBody columns={categoryColumns} data={salesByCategory} showTotal={true} totalAmount={defaultSummaryData.totalSales} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">المبيعات حسب طريقة الدفع</h3>
            <TemplateBody columns={paymentColumns} data={salesByPayment} showTotal={true} totalAmount={defaultSummaryData.totalSales} />
          </div>

          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">أفضل 5 منتجات</h3>
            <TemplateBody columns={productColumns} data={topProducts} showTotal={false} />
          </div>
